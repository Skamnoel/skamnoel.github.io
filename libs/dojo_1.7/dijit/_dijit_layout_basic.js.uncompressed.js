...
'*now':function(r){r(['dojo/i18n!*preload*dijit/nls/_dijit_layout_basic*["ar","ca","cs","da","de","el","en","es","fi","fr","he","hr","hu","it","ja","kk","ko","nl","no","pl","pt","pt-br","ro","ru","sk","sl","sv","th","tr","uk","zh","zh-tw","ROOT"]']);}
,
'*noref':1}});
define("dijit/_dijit_layout_basic", [], 1);
require(["dijit/layout/ContentPane","dijit/layout/LinkPane","dijit/TitlePane","dijit/Dialog","dijit/TooltipDialog"]);
